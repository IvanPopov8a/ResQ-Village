...
function buildSmsText(type, level, levelInfo, disasterInfo, alertId) {
  const messages = {
    flood: {
      3: `КРИТИЧНО: Риск от наводнение. Отидете на по-високо място СЕГА. Не минавайте през вода. Обадете се на 112. resq.bg/a/${alertId}`,
      2: `ВНИМАНИЕ: Повишен риск от наводнение в района. Следете нивото на реките. Пригответе се. resq.bg/a/${alertId}`,
      1: `Следим повишени нива на реките в района. Без непосредствена опасност. resq.bg/a/${alertId}`,
    },
    earthquake: {
      3: `ЗЕМЕТРЕСЕНИЕ: Засечен силен трус. Останете далеч от сгради. Проверете за газови течове. Обадете се на 112.`,
      2: `Земетресение M${''} в района. Проверете сградата за щети. Бъдете готови за вторични трусове.`,
      1: `Регистриран слаб трус в района. Без сериозна опасност. Следете официални съобщения.`,
    },
    fire: {
      3: `КРИТИЧНО: Горски пожар наближава района. Подгответе се за евакуация. Затворете прозорци. 112 при опасност.`,
      2: `ВНИМАНИЕ: Горски пожар в района. Не влизайте в засегнатата зона. Следете за промени.`,
      1: `Засечен горски пожар на по-голямо разстояние. Следим ситуацията. resq.bg/a/${alertId}`,
    },
  };
